  ...
  return (
    <div className='p-6 bg-linear-to-b from-[#faf6ef] to-[#e8ddc9] pt-32 h-[110vh]'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-4 lg-grid-cols-4 gap-5'>
        <StatCard icon={<FiUsers size={32}/>} label="Total Admins" 
        value={dashboardData.totalAdmins} color="#4F46E5"/>

        <StatCard icon={<FiBox size={32}/>} label="Total Products" 
        value={dashboardData.totalProducts} color="#0EA5E9"/>

        <StatCard icon={<FiFileText size={32}/>} label="Total Invoices" 
        value={dashboardData.totalInvoices} color="#F59E0B"/>

        <StatCard icon={<FiDollarSign size={32}/>} label="Total Sales" 
        value={dashboardData.totalSales + " $"} color="#10B981"/>
      </div>
