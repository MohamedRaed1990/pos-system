    ...
    <div className='pt-32 max-w-9xl mx-auto p-10 space-y-16 bg-[#f8f6f1]'>
        ...
        className='text-center space-y-4'>
            ...
            <p className='text-neutral-600 max-w-2xl mx-auto'>
                Track daily and periodic sales performance with
                live analytics, product insights, and data-driven visualization.
            </p>
        </motion.div>
        ...
        variants={{
            ...
            {[
                ...
                className='bg-white/90 backdrop-blur-xl border border-neutral-200
        ...
        className='bg-white rounded-3xl shadow-lg p-10 border border-neutral-200'>
        ...
        className='bg-white rounded-3xl p-10 shadow-lg border border-neutral-200'>
        ...
        className='bg-white/90 backdrop-blur-lg rounded-3xl p-10 shadow-lg border border-neutral-200'>
