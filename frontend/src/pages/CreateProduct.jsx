...
const CreateProduct = () => {
  ...
  return (
    ...
    flex justify-center'>
        ...
        className='w-full max-w-lg p-8 bg-white/90 backdrop-blur-xl border
        border-[#C9A86A]/25 rounded-2xl shadow-xl flex flex-col gap-6'>
            <h1 className='text-3xl font-bold text-yellow-600 flex items-center gap-3'>
                <Package size={36} className='text-yellow-600'/>Add New Product
            </h1>
            {error && (
            ...
            <form onSubmit={submit} className='flex flex-col gap-6'>
                ...
                focus:outline-none focus:ring-2 focus:ring-yellow-600' required/>
                ...
                className='mt-4 py-4 bg-linear-to-r from-yellow-400 to-orange-500 text-white
                font-bold rounded-xl hover:shadow-xl hover:shadow-textyellow-300/40 transition-all
