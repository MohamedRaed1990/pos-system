...
import { User , Receipt , Plus , Package , DollarSign , CreditCard , X } from 'lucide-react';
...
const Invoices = () => {
  ...
  const saveInvoice = async()=>{
    try{
      console.log('SENDING:', newInvoice);
  ...
  return (
    <div className='pt-32 p-10 bg-[#f6f4ef] min-h-screen'>
      ...
      className='flex items-center justify-between mb-10'>
        ...
        onClick={()=> setOpen(true)} className='px-5 py-3 flex items-center gap-2
      ...
      <AnimatePresence>
        {open&&(
          ...
          className='fixed inset-0 bg-black/40 backdrop-blur-sm flex justify-center
          items-center z-100'>
            ...
            border-[#C9A86A]/40'>
              ...
              <div className='mb-4'>
                ...
                value={newInvoice.customer} onChange={(e)=>
                  // setInvoices({...newInvoice,customer:e.target.value})
              ...
              <div className='mb-4'>
                ...
                {newInvoice.items.map((item,idx)=>(
                  <div key={idx} className='flex gap-3 mb-3 p-3 border
                ...
                <button onClick={addItem} className='mt-2 py-2 px-4 bg-[#C9A86A] text-white
                rounded-xl hover:bg-[#b8956f] transition'>
                  + Add Item
              ...
              <div className='flex justify-end mt-6'>
                ...
                onClick={saveInvoice} className='px-6 py-3 bg-[#C9A86A] text-white rounded-xl
